            ...
            {!this.state.isLoading ?
              ...
              <View>
                {this.state.data.length > 0 ?
                  <View>
                    <View style={{ flexDirection: 'row' }}>
                      <Text style={{ marginTop: 20, marginBottom: 10, marginLeft: 10 }}>BARKOD : </Text><Text style={{ fontWeight: 'bold', marginTop: 20, marginBottom: 10, }}> {this.state.code}</Text>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
                      <Text style={{ marginBottom: 10, marginLeft: 10 }}>PART NO : </Text><Text style={{ fontWeight: 'bold', marginBottom: 10, }}> {this.state.partNo}</Text>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
